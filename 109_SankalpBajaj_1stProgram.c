...
#include<stdio.h> //  Pre-Processive to include standard input and output function header files
#include <stdlib.h>  // Pre-Processive to include standard Library fucntion header files
void insert();  // Function Prototype
	 void del();  // Function Prototype
	  void search ();  // Function Prototype
int main()  // Main funtion 
{
	int ch,i; // Declaration of variable
	do

	{
		printf("      // Our heartiest congratulations //    ");
		printf("\nMain menu");
		printf(" \n1. Insert");
		printf("\n2.  Delete");
		printf("\n3. Search");
...
void del()
{
	...
	printf("\nElements Before Deleting elements respective array is: ");
    for(i=0;i<n;i++)
